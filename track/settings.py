...
DATE_INPUT_FORMATS = [
    '%d.%m.%Y',  # '25.10.2023'
    '%d.%m.%y',  # '25.10.23'
    '%Y-%m-%d',  # '2023-10-25' (стандартный формат)
    '%d/%m/%Y',  # '25/10/2023'
    '%d/%m/%y',  # '25/10/23'
]

# Отключаем локализацию для полей ввода дат (чтобы работали наши кастомные виджеты)
USE_L10N = False
...
SECRET_KEY = 'django-insecure--$^vkzxqsiok3#49#p1f%jyu_^5k*amx5(&=oqhcbx(vyd%l&v'

# SECURITY WARNING: don't run with debug turned on in production!

DEBUG = True
# ALLOWED_HOSTS = ['CDOMir.pythonanywhere.com', 'localhost'] # Замените 'yourusername' на ваше имя пользователя PA
# SECURITY WARNING: don't run with debug turned on in production!
